...
<section class="slider">
    <div class="slick-carousel m-slides-0"
      ...
      <div class="slide-item align-v-h">
        <div class="bg-img"><img src="{{ asset('assets/frontend/assets/images/sliders/1.jpg')}}" alt="slide img"></div>
        <div class="container">
      ...
      <div class="slide-item align-v-h">
        <div class="bg-img"><img src="{{ asset('assets/frontend/assets/images/sliders/2.jpg')}}" alt="slide img"></div>
        <div class="container">
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
              <div class="slide__content">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-6 offset-lg-3">
          <div class="heading text-center mb-40">
            ...
            <p class="heading__desc">Find your rechabale hospitals from here, Take your best treatment from any hospitals
          </div><!-- /.heading -->
        </div><!-- /.col-lg-6 -->
      </div><!-- /.row -->
      <div class="row">
          ...
          <div class="slick-carousel"
            ...
            <div class="member">
              <div class="member__img">
                <img src="{{asset('assets/frontend/assets/images/team/1.jpg')}}" alt="member img">
              </div><!-- /.member-img -->
              <div class="member__info">
                <h5 class="member__name"><a href="doctors-single-doctor1.html">Lab Aid Hospital</a></h5>
                ...
                <div class="mt-20 d-flex flex-wrap justify-content-between align-items-center">
                  <a href="single_hospital.html" class="btn btn__secondary btn__link btn__rounded">
                    <span>Read More</span>
            ...
            <div class="member">
              <div class="member__img">
                <img src="{{asset('assets/frontend/assets/images/team/2.jpg')}}" alt="member img">
              </div><!-- /.member-img -->
              <div class="member__info">
            ...
            <div class="member">
              <div class="member__img">
                <img src="{{asset('assets/frontend/assets/images/team/3.jpg')}}" alt="member img">
              </div><!-- /.member-img -->
              <div class="member__info">
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav__item has-dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="nav__item">
                      <a href="shop-single-product.html" class="nav__item-link">Ibne Sina Hospital</a>
                    </li><!-- /.nav-item -->
                    <li class="nav__item">
                      <a href="cart.html" class="nav__item-link">Khidmah Hospital</a>
                    </li><!-- /.nav-item -->
                  </ul><!-- /.dropdown-menu -->
                </li><!-- /.nav-item -->
                <li class="nav__item">
